...
function NTL.HealthScanner(usingCharacter, targetCharacter, limb) 

		local limbtype = HF.NormalizeLimbType(limb)
		NTL.PlayScannerSound(targetCharacter)
...
function NTL.PlayScannerSound(soundTarget)

	if NTL.ScannerActive==1 then
