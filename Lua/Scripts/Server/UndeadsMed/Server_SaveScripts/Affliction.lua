		...
		if entry.characterName == targetCharacter.Name then
			...
			for _, affliction in ipairs(entry.afflictions) do
				...
				if
					hasNanobots
					and (
						identifier == "tra_amputation"
						or identifier == "tla_amputation"
						or identifier == "trl_amputation"
						or identifier == "tll_amputation"
						or identifier == "sra_amputation"
						or identifier == "sla_amputation"
						or identifier == "srl_amputation"
						or identifier == "sll_amputation"
					)
				then
				...
				elseif
					...
					and (
						identifier == "noeye"
						or identifier == "eyesdead"
						or identifier == "eyeone"
						or identifier == "lefteyegone"
						or identifier == "righteyegone"
						or identifier == "eyelowbloodpressure"
						or identifier == "eyedamage"
						or identifier == "eyeshock"
						or identifier == "eyedrop"
						or identifier == "deusizinedrop"
						or identifier == "eyesickness"
						or identifier == "eyecataract"
						or identifier == "eyemuscle"
						or identifier == "eyegell"
						or identifier == "eyenerve"
						or identifier == "eyelid"
						or identifier == "eyepopped"
						or identifier == "corneaincision"
						or identifier == "emulsification"
						or identifier == "lasereyesurgery"
						or identifier == "hasglasses"
					)
				then
